...
int16_t ACMAMR::InternalEncode(uint8_t* bitstream,
  ...
  //if ((encoding_mode_ < WEBRTC_AMR_MR475) ||
   ...
   if ((encoding_mode_ < MR475) ||
      (encoding_mode_ > MR122)) {
...
//
//#define WEBRTC_AMR_MR475  0  -> MR475 = 0,
//#define WEBRTC_AMR_MR515  1  -> MR515
//#define WEBRTC_AMR_MR59   2  -> MR59
//#define WEBRTC_AMR_MR67   3  -> MR67
//#define WEBRTC_AMR_MR74   4  -> MR74
//#define WEBRTC_AMR_MR795  5  -> MR795
//#define WEBRTC_AMR_MR102  6  -> MR102
//#define WEBRTC_AMR_MR122  7  -> MR122
int16_t ACMAMR::SetBitRateSafe(const int32_t rate) {
  switch (rate) {
    case 4750: {
      //encoding_mode_ = WEBRTC_AMR_MR475;
      encoding_mode_ = MR475;
      encoding_rate_ = 4750;
      break;
    }
    case 5150: {
      //encoding_mode_ = WEBRTC_AMR_MR515;
      encoding_mode_ = MR515;
      encoding_rate_ = 5150;
      break;
    }
    case 5900: {
    ...
    case 7950: {
      ...
      encoding_mode_ = MR795;
      encoding_rate_ = 7950;
      break;
    }
    case 10200: {
      //encoding_mode_ = WEBRTC_AMR_MR102;
      encoding_mode_ = MR102;
