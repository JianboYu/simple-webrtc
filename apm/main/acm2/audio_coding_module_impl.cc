...
#include "main/acm2/audio_coding_module_impl.h"
...
#include "main/acm2/acm_generic_codec.h"
#include "main/acm2/acm_resampler.h"
#include "main/acm2/call_statistics.h"
...
void AudioCodingModuleImpl::Process() {
  bool dual_stream;
  {
    CriticalSectionScoped lock(acm_crit_sect_);
...
//add by fanwei------------------start
   ...
   case acm2::ACMCodecDB::kG722_1C_24:
   case acm2::ACMCodecDB::kG722_1C_32:
   case acm2::ACMCodecDB::kG722_1C_48:
      *codec_name = "G7221";
      *sample_rate_hz = 32000;
      *channels = 1;
      break;
   ...
   case acm2::ACMCodecDB::kGSMAMRWB:
      *codec_name = "AMR-WB";
      *sample_rate_hz = 16000;
      *channels = 1;
      break;
   ...
   case acm2::ACMCodecDB::kAACLC_16K:
      *codec_name = "AACLC";
      *sample_rate_hz = 16000;
      *channels = 1;
      break;
   case acm2::ACMCodecDB::kAACLC_32K:
      *codec_name = "AACLC";
      *sample_rate_hz = 32000;
      *channels = 1;
      break;
   case acm2::ACMCodecDB::kAACLC_48K:
      *codec_name = "AACLC";
      *sample_rate_hz = 48000;
      *channels = 1;
      break;
#if 0
   case acm2::ACMCodecDB::kAACLC_16K_2CH:
      *codec_name = "AACLC";
      *sample_rate_hz = 16000;
      *channels = 2;
      break;
   case acm2::ACMCodecDB::kAACLC_32K_2CH:
      *codec_name = "AACLC";
      *sample_rate_hz = 32000;
      *channels = 2;
      break;
   case acm2::ACMCodecDB::kAACLC_48K_2CH:
      *codec_name = "AACLC";
      *sample_rate_hz = 48000;
      *channels = 2;
      break;
