...
int16_t ACMG722_1C::InternalEncode(uint8_t* bitstream,
  ...
  if (num_channels_ == 2) {
    ...
    memcpy(left_channel, &in_audio_[in_audio_ix_read_], 640*2);
  }
...
int16_t ACMG722_1C::InternalInitEncoder(WebRtcACMCodecParams* codec_params) {
  ...
  switch (operational_rate_) {
    case 24000: {
      ret = WebRtcG7221C_EncoderInit24(encoder_inst24_ptr_);
      if (ret < 0) {
        return ret;
      }
      if (num_channels_ == 2) {
      return WebRtcG7221C_EncoderInit24(encoder_inst24_ptr_right_);
      }
      else
      {
      		return ret;
    ...
    case 32000: {
      ret = WebRtcG7221C_EncoderInit32(encoder_inst32_ptr_);
      if (ret < 0) {
        return ret;
      }
      if (num_channels_ == 2) {
      return WebRtcG7221C_EncoderInit32(encoder_inst32_ptr_right_);
      }
      else
      {
      		return ret;
    ...
    case 48000: {
      ret = WebRtcG7221C_EncoderInit48(encoder_inst48_ptr_);
      if (ret < 0) {
        return ret;
      }
      if (num_channels_ == 2) {
      return WebRtcG7221C_EncoderInit48(encoder_inst48_ptr_right_);
      }
      else
      {
      		return ret;
...
void ACMG722_1C::DestructEncoderSafe() {
  ...
  if(encoder_inst24_ptr_!=NULL)
  {
  	WebRtcG7221C_FreeEnc24(&encoder_inst24_ptr_);
  }
  if(encoder_inst24_ptr_right_!=NULL)
  {
  	WebRtcG7221C_FreeEnc24(&encoder_inst24_ptr_right_);
  }
  if(encoder_inst32_ptr_!=NULL)
  {
  	WebRtcG7221C_FreeEnc32(&encoder_inst32_ptr_);
  }
  if(encoder_inst32_ptr_right_!=NULL)
  {
  	WebRtcG7221C_FreeEnc32(&encoder_inst32_ptr_right_);
  }
  if(encoder_inst48_ptr_!=NULL)
  {
  	WebRtcG7221C_FreeEnc48(&encoder_inst48_ptr_);
  }
  if(encoder_inst48_ptr_right_!=NULL)
  {
  	WebRtcG7221C_FreeEnc48(&encoder_inst48_ptr_right_);
  }
  encoder_inst24_ptr_ = NULL;
  encoder_inst32_ptr_ = NULL;
  encoder_inst48_ptr_ = NULL;
