...
#include "main/acm2/acm_codec_database.h"

#include <assert.h>

#include "main/acm2/acm_common_defs.h"
#include "neteq/interface/audio_decoder.h"
#include "system_wrappers/interface/trace.h"

// Includes needed to create the codecs.
// G711, PCM mu-law and A-law
#include "main/acm2/acm_pcma.h"
#include "main/acm2/acm_pcmu.h"
#include "codecs/g711/include/g711_interface.h"
// CNG
#include "codecs/cng/include/webrtc_cng.h"
#include "main/acm2/acm_cng.h"
...
#include "main/acm2/acm_isac.h"
#include "main/acm2/acm_isac_macros.h"
#endif
#ifdef WEBRTC_CODEC_PCM16
#include "codecs/pcm16b/include/pcm16b.h"
#include "main/acm2/acm_pcm16b.h"
#endif
#ifdef WEBRTC_CODEC_ILBC
#include "codecs/ilbc/interface/ilbc.h"
#include "main/acm2/acm_ilbc.h"
#endif
#ifdef WEBRTC_CODEC_AMR
#include "main/acm2/acm_amr.h"
#endif
#ifdef WEBRTC_CODEC_AMRWB
#include "main/acm2/acm_amrwb.h"
#endif
#ifdef WEBRTC_CODEC_CELT
#include "codecs/celt/include/celt_interface.h"
#include "main/acm2/acm_celt.h"
#endif
#ifdef WEBRTC_CODEC_G722
#include "codecs/g722/include/g722_interface.h"
#include "main/acm2/acm_g722.h"
#endif
#ifdef WEBRTC_CODEC_G722_1
#include "codecs/g7221/include/g7221_interface.h"
#include "main/acm2/acm_g7221.h"
#endif
#ifdef WEBRTC_CODEC_G722_1C
#include "main/acm2/acm_g7221c.h"
#endif
#ifdef WEBRTC_CODEC_G729
#include "codecs/g729/include/g729_interface.h"
#include "main/acm2/acm_g729.h"
#endif
#ifdef WEBRTC_CODEC_G729_1
#include "codecs/g7291/include/g7291_interface.h"
#include "main/acm2/acm_g7291.h"
#endif
#ifdef WEBRTC_CODEC_GSMFR
#include "codecs/gsmfr/include/gsmfr_interface.h"
#include "main/acm2/acm_gsmfr.h"
#endif
#ifdef WEBRTC_CODEC_OPUS
#include "codecs/opus/interface/opus_interface.h"
#include "main/acm2/acm_opus.h"
#endif
#ifdef WEBRTC_CODEC_SPEEX
#include "codecs/speex/include/speex_interface.h"
#include "main/acm2/acm_speex.h"
#endif
#ifdef WEBRTC_CODEC_AVT
#include "main/acm2/acm_dtmf_playout.h"
#endif
#ifdef WEBRTC_CODEC_RED
#include "main/acm2/acm_red.h"
#endif
...
#endif
#ifdef WEBRTC_CODEC_G722_1C
  {89, "G7221C_48000", 32000, 640, 1, 48000},
  {88, "G7221C_32000", 32000, 640, 1, 32000},
  {87, "G7221C_24000", 32000, 640, 1, 24000},
#endif
#ifdef WEBRTC_CODEC_G729
...
#endif
  } else if (!STR_CASE_CMP(codec_inst.plname, "G7221") || !STR_CASE_CMP(codec_inst.plname, "G7221C_48000")
  || !STR_CASE_CMP(codec_inst.plname, "G7221C_32000") || !STR_CASE_CMP(codec_inst.plname, "G7221C_24000")) 
  {
