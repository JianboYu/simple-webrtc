...
int16_t ACMAMRwb::InternalEncode(uint8_t* bitstream,
  ...
  if ((encoding_mode_ < MR66) || (encoding_mode_ > MR2385)) {
...
//the webrtc amr mode to kedacom amr mode.
//total rate mode following:
 /*
	#define AMRWB_MODE_7k    -> MR66
	#define AMRWB_MODE_9k    -> MR885
	#define AMRWB_MODE_12k   -> MR1265
	#define AMRWB_MODE_14k   -> MR1425
	#define AMRWB_MODE_16k   -> MR1585
	#define AMRWB_MODE_18k   -> MR1825
	#define AMRWB_MODE_20k   -> MR1985
	#define AMRWB_MODE_23k   -> MR2305
	#define AMRWB_MODE_24k   -> MR2385
*/
