...
//add by fanwei------------------start
  ...
  case kDecoderAACLC_16K:
  case kDecoderAACLC_32K:
  case kDecoderAACLC_48K:
#if 0
...
#ifdef WEBRTC_CODEC_ADPCM
    case kDecoderADPCM:
	return new AudioDecoderADPCM(codec_type);
#endif
#ifdef WEBRTC_CODEC_G722_1C
    case kDecoderG722_1C_24:
    case kDecoderG722_1C_32:
    case kDecoderG722_1C_48:
	return new AudioDecoderG722_1C(codec_type);
#endif
#ifdef WEBRTC_CODEC_AMR
    case kDecoderAMR:
	return new AudioDecoderAMR(codec_type);
#endif
#ifdef WEBRTC_CODEC_AMRWB
    case kDecoderAMRWB:
	return new AudioDecoderAMRWB(codec_type);
#endif
#ifdef WEBRTC_CODEC_AACLC
    case kDecoderAACLC_16K:
    case kDecoderAACLC_32K:
    case kDecoderAACLC_48K:
	return new AudioDecoderAACLC(codec_type);
#if 0
    case kDecoderAACLC_16K_2CH:
    case kDecoderAACLC_32K_2CH:
    case kDecoderAACLC_48K_2CH:
	return new AudioDecoderAACLCMultiCh(codec_type);
#endif
#endif
//add by fanwei------------------end
#endif
