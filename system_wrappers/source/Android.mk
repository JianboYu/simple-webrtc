...
LOCAL_ARM_MODE := arm
LOCAL_MODULE := system_wrappers-a
LOCAL_MODULE_FILENAME := libwebrtc_system_wrappers
...
LOCAL_CPPFLAGS := -DWEBRTC_LINUX -DWEBRTC_POSIX -DWEBRTC_ANDROID -std=gnu++11
LOCAL_LDLIBS := -llog
...
#include $(LOCAL_PATH)/android-webrtc.mk
#LOCAL_ARM_MODE := arm
#LOCAL_MODULE := system_wrappers-so
#LOCAL_MODULE_FILENAME := libwebrtc_system_wrappers
#LOCAL_MODULE_TAGS := optional
#LOCAL_CPP_EXTENSION := .cc
#LOCAL_SRC_FILES := \
