...
#include "rtp_rtcp/include/rate_limiter.h"
#include "rtp_rtcp/include/rtc_event_log.h"
#include "rtp_rtcp/include/rtp_cvo.h"
#include "rtp_rtcp/source/byte_io.h"
#include "rtp_rtcp/source/playout_delay_oracle.h"
#include "rtp_rtcp/source/rtp_sender_audio.h"
#include "rtp_rtcp/source/rtp_sender_video.h"
...
RTPSender::RTPSender(
  ...
  send_critsect_.reset(CriticalSectionWrapper::CreateCriticalSection());
  statistics_crit_.reset(CriticalSectionWrapper::CreateCriticalSection());
}
