...
#include "rtp_rtcp/source/receive_statistics_impl.h"
...
StreamStatisticianImpl::StreamStatisticianImpl(
  ...
  stream_lock_.reset(CriticalSectionWrapper::CreateCriticalSection());
}
...
ReceiveStatisticsImpl::ReceiveStatisticsImpl(Clock* clock)
  ...
  receive_statistics_lock_.reset(CriticalSectionWrapper::CreateCriticalSection());
}
