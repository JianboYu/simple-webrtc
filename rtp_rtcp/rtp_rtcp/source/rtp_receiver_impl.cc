...
#include "rtp_rtcp/source/rtp_receiver_impl.h"
...
#include "rtp_rtcp/include/rtp_receiver_strategy.h"
...
RtpReceiverImpl::RtpReceiverImpl(
  ...
  critical_section_rtp_receiver_.reset(CriticalSectionWrapper::CreateCriticalSection());
}
