...
#include "rtp_rtcp/source/rtcp_receiver_help.h"
...
protected:
 ...
 private:
  ...
  scoped_ptr<CriticalSectionWrapper> _criticalSectionFeedbacks;
  ...
  scoped_ptr<CriticalSectionWrapper> _criticalSectionRTCPReceiver;
