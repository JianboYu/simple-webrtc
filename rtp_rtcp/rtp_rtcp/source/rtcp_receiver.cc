...
#include "rtp_rtcp/source/rtcp_receiver.h"
...
#include "rtp_rtcp/source/rtcp_utility.h"
#include "rtp_rtcp/source/rtp_rtcp_impl.h"
#include "rtp_rtcp/source/time_util.h"
#include "rtp_rtcp/source/tmmbr_help.h"
#include "system_wrappers/interface/ntp_time.h"
...
RTCPReceiver::RTCPReceiver(
  ...
  _criticalSectionRTCPReceiver.reset(CriticalSectionWrapper::CreateCriticalSection());
  _criticalSectionFeedbacks.reset(CriticalSectionWrapper::CreateCriticalSection());
}
...
int64_t RTCPReceiver::LastReceived() {
  CriticalSectionScoped cs(_criticalSectionRTCPReceiver.get());
...
void RTCPReceiver::HandleSDESChunk(RTCPUtility::RTCPParserV2& rtcpParser) {
  ...
  {
    CriticalSectionScoped cs(_criticalSectionFeedbacks.get());
